...
extern "C" {
    ...
    double calculate_failure_rate(
        ...
        // We assume TSA takes ~18 mins on average, but variance changes this.
        double avg_tsa_mins = 18.0;
...
int main() {
    ...
    // TSA: +/- 10 mins
    // Walk: 10 mins
    double risk = calculate_failure_rate(90.0, 45.0, 10.0, 10.0, 10.0, 10000);
